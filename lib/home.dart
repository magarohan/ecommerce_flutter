...
class _HomePageState extends State<HomePage> {
  ...
  final List<Product> hoodies = const [
    Product(
      image:
  ...
  final List<Product> shoes = const [
    Product(
  ...
  final List<Product> shirts = const [
    Product(
      image:
  ...
  final List<Product> pants = const [
    Product(
      image:
    ...
    Product(
      image:
          'https://i.pinimg.com/1200x/25/9b/f2/259bf2e9bc4d1b85535ee8d947007a65.jpg',
      name: 'Pant 2',
      price: 3500,
      description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
    ),
  ...
  final List<Product> watches = const [
    Product(
      image:
        ...
        child: ListView(
          ...
          children: [
            ...
            GridView(
              ...
              children: [
                CategoryGridWidget(title: 'Hoodies', products: hoodies),
                CategoryGridWidget(title: 'Shoes', products: shoes),
                CategoryGridWidget(title: 'Shirts', products: shirts),
                CategoryGridWidget(title: 'Pants', products: pants),
                CategoryGridWidget(title: 'Bags', products: bags),
                CategoryGridWidget(title: 'Watches', products: watches),
              ],
            ),
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  _circleIcon(hoodies[0]),
                  SizedBox(width: 12.w),
                  _circleIcon(shoes[1]),
                  _circleIcon(watches[2]),
                  _circleIcon(bags[3]),
                  _circleIcon(pants[3]),
                ],
              ),
  ...
  Widget _circleIcon(Product product) {
    return Container(
