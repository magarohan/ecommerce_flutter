...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void initState() {
    super.initState();
    context.read<UserBloc>().add(const UserFetched(id: 1));
  }
      ...
      body: SafeArea(
        child: BlocBuilder<UserBloc, UserState>(
          builder: (context, state) {
            if (state.userFetchedStatus == AppStatus.loading) {
              return const Center(child: CircularProgressIndicator());
            }
            if (state.userFetchedStatus == AppStatus.failure) {
            ...
            final fullName = user != null
                ...
                : 'John Doe';
            final displayEmail = user?.email ?? 'john.doe@example.com';
